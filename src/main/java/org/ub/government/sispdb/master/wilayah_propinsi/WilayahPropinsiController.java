...
import org.ub.government.sispdb.master.wilayah_propinsi.WilayahPropinsiView.OnViewListener;
import org.ub.government.sispdb.model.Propinsi;
import org.ub.government.sispdb.model_enum.EnumStatusOperasiForm;

public class WilayahPropinsiController implements OnViewListener{
	protected WilayahPropinsiModel model;
	protected WilayahPropinsiView view;

	public WilayahPropinsiController(WilayahPropinsiView view) {
		model = new WilayahPropinsiModel();
		this.view = view;
	}
