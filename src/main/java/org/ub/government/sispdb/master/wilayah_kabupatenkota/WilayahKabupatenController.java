...
import org.ub.government.sispdb.master.wilayah_kabupatenkota.WilayahKabupatenView.OnViewListener;
import org.ub.government.sispdb.model.Kabupaten;
import org.ub.government.sispdb.model.Kabupaten;
import org.ub.government.sispdb.model_enum.EnumStatusOperasiForm;

public class WilayahKabupatenController implements OnViewListener{
	protected WilayahKabupatenModel model;
	protected WilayahKabupatenView view;

	public WilayahKabupatenController(WilayahKabupatenView view) {
		model = new WilayahKabupatenModel();
		this.view = view;
	}
