...
public class JenisPerairanView extends FormTemplate1_IntFrame{
	protected JenisPerairanController controller;
	protected JenisPerairanModel model;
	
	private TableRowSorter<TableModel_JenisPerairan> tableRowSorter;
	 ...
	 */
		...
		public JenisPerairanView() {
			super();
			controller = new JenisPerairanController(this);
...
//			dataProvider.refreshAll();
			model.tableModelHeader = new TableModel_JenisPerairan(new ArrayList<>(model.listHeader.values()));
...
//			grid1.setDataProvider(dataProvider);
			...
			tableRowSorter = new TableRowSorter<TableModel_JenisPerairan>(model.tableModelHeader);
		...
		public void setTableModelOrFilter() {
			RowFilter<TableModel_JenisPerairan,Object> rowFilter = null;
			
			ArrayList<RowFilter<TableModel_JenisPerairan, Object>> arrListFilters = new ArrayList<RowFilter<TableModel_JenisPerairan,Object>>();
			RowFilter<TableModel_JenisPerairan,Object> kode1_Filter = null;
			RowFilter<TableModel_JenisPerairan,Object> desc_Filter = null;
		...
		public void setTableModelFilter(int columnIndex) {
		    RowFilter<TableModel_JenisPerairan, Object> rf = null;
