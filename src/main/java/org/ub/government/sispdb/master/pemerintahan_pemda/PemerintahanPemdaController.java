...
import org.ub.government.sispdb.master.pemerintahan_pemda.PemerintahanPemdaView.OnViewListener;
import org.ub.government.sispdb.model.Kabupaten;
import org.ub.government.sispdb.model.Kabupaten;
import org.ub.government.sispdb.model_enum.EnumStatusOperasiForm;

public class PemerintahanPemdaController implements OnViewListener{
	protected PemerintahanPemdaModel model;
	protected PemerintahanPemdaView view;

	public PemerintahanPemdaController(PemerintahanPemdaView view) {
		model = new PemerintahanPemdaModel();
		this.view = view;
	}
