...
import org.ub.government.sispdb.master.pemerintahan_satker.PemerintahanSatkerView.OnViewListener;
import org.ub.government.sispdb.model.Kabupaten;
import org.ub.government.sispdb.model.Kabupaten;
import org.ub.government.sispdb.model_enum.EnumStatusOperasiForm;

public class PemerintahanSatkerController implements OnViewListener{
	protected PemerintahanSatkerModel model;
	protected PemerintahanSatkerView view;

	public PemerintahanSatkerController(PemerintahanSatkerView view) {
		model = new PemerintahanSatkerModel();
		this.view = view;
	}
