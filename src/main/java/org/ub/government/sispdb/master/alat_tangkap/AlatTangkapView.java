...
public class AlatTangkapView extends FormTemplate1_IntFrame{
	protected AlatTangkapController controller;
	protected AlatTangkapModel model;
	
	private TableRowSorter<TableModel_AlatTangkap> tableRowSorter;
	 ...
	 */
		...
		public AlatTangkapView() {
			super();
			controller = new AlatTangkapController(this);
...
//			dataProvider.refreshAll();
			model.tableModelHeader = new TableModel_AlatTangkap(new ArrayList<>(model.listHeader.values()));
...
//			grid1.setDataProvider(dataProvider);
			...
			tableRowSorter = new TableRowSorter<TableModel_AlatTangkap>(model.tableModelHeader);
		...
		public void setTableModelOrFilter() {
			RowFilter<TableModel_AlatTangkap,Object> rowFilter = null;
			
			ArrayList<RowFilter<TableModel_AlatTangkap, Object>> arrListFilters = new ArrayList<RowFilter<TableModel_AlatTangkap,Object>>();
			RowFilter<TableModel_AlatTangkap,Object> kode1_Filter = null;
			RowFilter<TableModel_AlatTangkap,Object> desc_Filter = null;
		...
		public void setTableModelFilter(int columnIndex) {
		    RowFilter<TableModel_AlatTangkap, Object> rf = null;
