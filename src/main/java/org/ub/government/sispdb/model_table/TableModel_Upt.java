 ...
 * @author yhawin
 */
public class TableModel_Upt extends AbstractTableModel{
    List <Upt> list = new ArrayList <Upt>();
    //private String[] columnNames = {“Nama”, “NIM”,”Jurusan”, “Alamat”};

    public TableModel_Upt(List<Upt> list){
        this.list = list;
    }
...
//        }
    ...
    //TAMBAHAN KITA
    public Upt get(int index){
        return list.get(index);
    }

    public void insert(Upt object){
        list.add(object);
        fireTableRowsInserted(getRowCount()-1,getRowCount()-1);
    }
    public void update(Upt object, int index){
