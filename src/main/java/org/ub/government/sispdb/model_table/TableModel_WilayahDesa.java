 ...
 * @author yhawin
 */
public class TableModel_WilayahDesa extends AbstractTableModel{
    List <Desa> list = new ArrayList <Desa>();
    //private String[] columnNames = {“Nama”, “NIM”,”Jurusan”, “Alamat”};

    public TableModel_WilayahDesa(List<Desa> list){
        this.list = list;
    }
    ...
    //TAMBAHAN KITA
    public Desa get(int index){
        return list.get(index);
    }

    public void insert(Desa object){
        list.add(object);
        fireTableRowsInserted(getRowCount()-1,getRowCount()-1);
    }
    public void update(Desa object, int index){
