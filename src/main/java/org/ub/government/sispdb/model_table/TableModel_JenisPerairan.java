 ...
 * @author yhawin
 */
public class TableModel_JenisPerairan extends AbstractTableModel{
    List <JenisPerairan> list = new ArrayList <JenisPerairan>();
    //private String[] columnNames = {“Nama”, “NIM”,”Jurusan”, “Alamat”};

    public TableModel_JenisPerairan(List<JenisPerairan> list){
        this.list = list;
    }
...
//        }
    ...
    //TAMBAHAN KITA
    public JenisPerairan get(int index){
        return list.get(index);
    }

    public void insert(JenisPerairan object){
        list.add(object);
        fireTableRowsInserted(getRowCount()-1,getRowCount()-1);
    }
    public void update(JenisPerairan object, int index){
