 ...
 * @author yhawin
 */
public class TableModel_IkanJenis extends AbstractTableModel{
    List <IkanJenis> list = new ArrayList <IkanJenis>();
    //private String[] columnNames = {“Nama”, “NIM”,”Jurusan”, “Alamat”};

    public TableModel_IkanJenis(List<IkanJenis> list){
        this.list = list;
    }
...
//        }
    ...
    //TAMBAHAN KITA
    public IkanJenis get(int index){
        return list.get(index);
    }

    public void insert(IkanJenis object){
        list.add(object);
        fireTableRowsInserted(getRowCount()-1,getRowCount()-1);
    }
    public void update(IkanJenis object, int index){
