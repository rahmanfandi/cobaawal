 ...
 * @author yhawin
 */
public class TableModel_UnitKerja extends AbstractTableModel{
    List <UnitKerja> list = new ArrayList <UnitKerja>();
    //private String[] columnNames = {“Nama”, “NIM”,”Jurusan”, “Alamat”};

    public TableModel_UnitKerja(List<UnitKerja> list){
        this.list = list;
    }
...
//        }
    ...
    //TAMBAHAN KITA
    public UnitKerja get(int index){
        return list.get(index);
    }

    public void insert(UnitKerja object){
        list.add(object);
        fireTableRowsInserted(getRowCount()-1,getRowCount()-1);
    }
    public void update(UnitKerja object, int index){
