 ...
 * @author yhawin
 */
public class TableModel_AlatTangkap extends AbstractTableModel{
    List <AlatTangkap> list = new ArrayList <AlatTangkap>();
    //private String[] columnNames = {“Nama”, “NIM”,”Jurusan”, “Alamat”};

    public TableModel_AlatTangkap(List<AlatTangkap> list){
        this.list = list;
    }
...
//        }
    ...
    //TAMBAHAN KITA
    public AlatTangkap get(int index){
        return list.get(index);
    }

    public void insert(AlatTangkap object){
        list.add(object);
        fireTableRowsInserted(getRowCount()-1,getRowCount()-1);
    }
    public void update(AlatTangkap object, int index){
